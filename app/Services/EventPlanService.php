    ...
    public function publish(EventPlan $plan): Hike
    {
        return DB::transaction(function () use ($plan) {
            ...
            $hike = Hike::create([
                ...
                'accommodation_name'            => $plan->accommodation_name,
                'accommodation_cost_per_person' => $plan->accommodation_cost_per_person ?? 0,
                'what_is_included'              => $plan->what_is_included,
                'what_to_bring'                 => $plan->what_to_bring,
            ]);
